...
const DEFAULT_FILES: FileEntry[] = [
  ...
  { id: "f3", name: "hh.md",         type: "file", ext: "md" },
  { id: "f4", name: "style.css",     type: "file", ext: "css" },
  { id: "f5", name: "README.md",     type: "file", ext: "md" },
  { id: "f6", name: "index.html",    type: "file", ext: "html" },
  { id: "f7", name: "game.js",       type: "file", ext: "js" },
  { id: "f8", name: "logo.png",      type: "file", ext: "png" },
];
 ...
 * │  [打开文件夹] [项目技能 N]  ← action buttons      │
 * ├───────────────────────────────────────────────────┤
 * │  Skills badge row  技能 · N                       │
 * ├───────────────────────────────────────────────────┤
 * │  Sort row                   [时间 ▾]              │
 * ├───────────────────────────────────────────────────┤
 ...
 * • section gaps: border-b border-border between zones
 * • file tree: px-3 pb-4
 *
 * Colors
 * • panel bg       : var(--surface)
 * • border         : border-border
 * • skills badge   : bg-status-active-bg, color status-active
 * • sort button    : text-muted-foreground → text-foreground on hover
 * • action buttons : bg-accent → bg-secondary on hover, border-border/60
 */
      ...
      <div className="flex items-center justify-end px-4 py-2 shrink-0">
        <button
          onClick={() => {
            ...
            console.log("InspectorPanel: sort direction toggled");
          }}
