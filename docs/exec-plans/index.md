...
| [草案]         | Phase 6D     | Skills 控制平面 — Bundled/Review/Distribution/Authoring          | `docs/exec-plans/active/phase-6d-skills-control-plane.yaml`      | SKILL-CP-P0-CORE~SKILL-CP-P3-AGENT-AUTHORING                                             |
