...
| **[当前]**       | Phase 7B     | Browser Control System — openhanako Parity                       | `docs/exec-plans/active/phase-7b-browser-control-system.yaml`      | 7B.1~7B.8 (chromiumoxide + AXTree + BrowserCard, 8 slices)                                                              |
