...
| 草案             | Phase 7C     | Browser Subsystem Remediation — 12 Gap 全量纠正                  | `docs/exec-plans/active/phase-7c-browser-subsystem-remediation.yaml`   | 7C.1~7C.13 (profile / vision / headed / routing / wait / tabs / iframe / download / console / readability / web_research / quality / harness, 13 slices, 25-30 工程日, design-ref ADR-015) |
...
| **[当前]**       | Phase 8B     | Memory Compiler & Ticker (S2)                                    | `docs/exec-plans/active/phase-8b-memory-compiler-and-ticker.yaml`      | T-C1~T-C5, T-D1~T-D4, T-UI-2, T-UI-3 (11 slices, ~10 工程日)                                                                                                                               |
