...
| **[当前]**       | Phase 8A     | Memory Hardening & Pinned (S1)                                   | `docs/exec-plans/active/phase-8a-memory-hardening-and-pinned.yaml`     | T-A1~T-A4, T-B1~T-B4, T-F1~T-F5 (12 slices, ~10 工程日)                                                                                                                                    |
| 草案             | Phase 8B     | Memory Compiler & Ticker (S2)                                    | `docs/exec-plans/active/phase-8b-memory-compiler-and-ticker.yaml`      | T-C1~T-C5, T-D1~T-D4, T-UI-2, T-UI-3 (11 slices, ~10 工程日)                                                                                                                               |
