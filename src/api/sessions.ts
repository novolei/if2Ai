...
// the cut-over.
import type { Session, SessionMeta } from '@/lib/tauri'
...
export async function createSession(
  ...
  return getApiClient().call<SessionMeta>('create_session', { projectId, title })
}
...
export async function renameSession(id: string, title: string): Promise<SessionMeta> {
