...
use commands::{
    ...
    harness_begin_run,
    harness_compare_reports,
    harness_current_run_id,
    harness_delete_report,
    harness_evaluate_compare,
    harness_evaluate_suite,
    harness_finalize_and_rotate_run,
    harness_finalize_run,
    harness_list_reports,
    harness_load_corpus,
    harness_load_report,
    harness_save_report,
    hub_audit,
    ...
    hub_uninstall,
    hub_update,
    // Learning candidate registry IPC (Phase M5-A + M5-B + M5-C round 1 + M5-C round 2)
    learning_activate_promoted_candidate,
    learning_apply_promotion_gate,
    learning_attach_compare_ref,
    learning_attach_recommendation,
    learning_delete_candidate,
    learning_evaluate_candidate,
    learning_evaluate_candidate_against_suite,
    learning_evaluate_candidate_with_policy,
    learning_get_active_strategies,
    learning_get_candidate,
    learning_inspect_evaluation_progress,
    learning_list_candidates,
    learning_mark_promoted_candidate,
    learning_reflect_session_and_register,
    learning_register_candidate_from_reflection,
    learning_register_candidate_manual,
    learning_rollback_active_strategy,
    learning_generate_reflection_for_report,
    learning_resolve_active_overlay,
    learning_score_run_report,
    learning_set_candidate_compare_target,
    learning_set_candidate_definition,
    learning_set_candidate_notes,
    learning_set_candidate_state,
    list_agents,
...
fn main() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            harness_evaluate_compare,
            harness_evaluate_suite,
            // Learning candidate registry IPC (Phase M5-A + M5-B)
            learning_register_candidate_from_reflection,
            learning_register_candidate_manual,
            learning_list_candidates,
            learning_get_candidate,
            ...
            tts_warm_voice_preview,
            tts_cached_voice_preview,
            // STT — OpenFlow / SenseVoice only (Apr 2026 simplification)
            stt_model_status,
            stt_download_openflow_model,
            stt_transcribe,
            stt_get_settings,
