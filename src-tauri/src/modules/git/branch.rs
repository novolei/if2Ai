...
mod tests {
    ...
    fn current_branch_reports_main_in_seed_repo() {
        let repo = crate::modules::git::test_support::TestRepo::new("current");
    ...
    fn branch_exists_true_for_main_false_for_unknown() {
        let repo = crate::modules::git::test_support::TestRepo::new("exists");
    ...
    fn detect_default_branch_returns_main_when_origin_absent() {
        let repo = crate::modules::git::test_support::TestRepo::new("default");
    ...
    fn list_branches_verbose_includes_main() {
        let repo = crate::modules::git::test_support::TestRepo::new("list-branches");
