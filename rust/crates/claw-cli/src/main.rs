...
fn default_model() -> String {
    api::read_model_override().ok().flatten().map_or_else(
...
mod tests {
    use super::{
        ...
        normalize_permission_mode, parse_git_status_metadata, permission_policy, print_help_to,
        push_output_block, render_config_report, render_memory_report, render_repl_help,
        render_unknown_repl_command, resolve_model_alias, response_to_events,
